// deploy: npx hardhat deploy --network binance_testnet --tags ChildAliERC20v2
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// ChildAliERC20v2 – L2 networks like Polygon or BNB
	{
		// deploy if required
		await deployments.deploy("ChildAliERC20v2", {
...
module.exports.tags = ["ChildAliERC20v2", "v2_9", "deploy", "L2", "l2"];
