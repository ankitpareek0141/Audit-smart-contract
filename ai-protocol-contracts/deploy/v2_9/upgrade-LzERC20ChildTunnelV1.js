// upgrade: npx hardhat deploy --network binance_testnet --tags upgrade-LzERC20ChildTunnelV1
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// LzERC20ChildTunnel ERC1967Proxy
	{
		...
		if(implementation_address !== web3.utils.toChecksumAddress(v1_deployment.address)) {
			...
			console.log("LzERC20ChildTunnel_Proxy.upgradeTo(%o): %o", v1_deployment.address, receipt.transactionHash);
		}
	}
};
...
module.exports.tags = ["upgrade-LzERC20ChildTunnelV1", "v2_9", "upgrade", "L2", "l2"];
module.exports.dependencies = ["LzERC20ChildTunnelV1", "LzERC20ChildTunnel_Proxy"];
