// deploy: npx hardhat deploy --network goerli --tags LzERC20RootTunnelV1
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// Root AliERC20 contracts are available only in L1
	...
	// LzERC20RootTunnelV1
	{
		...
		// deploy if required
		await deployments.deploy("LzERC20RootTunnelV1", {
		...
		const deployment = await deployments.get("LzERC20RootTunnelV1");
...
module.exports.tags = ["LzERC20RootTunnelV1", "v2_9", "deploy", "L1", "l1"];
