// run: npx hardhat deploy --network goerli --tags config_lzAppConf-LzERC20RootTunnel
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// config LZ Endpoint: LzERC20RootTunnel
	{
		...
		async function setConfig(conf_type, conf_value) {
			...
			console.log(
				"LzERC20RootTunnel_Proxy.setConfig(%o, %o, %o, %o): %o",
				lz_lib_version,				// uint16 _version
...
module.exports.tags = ["config_lzAppConf-LzERC20RootTunnel", "v2_9", "config", "L1", "l1"];
module.exports.dependencies = ["LzERC20RootTunnel_Proxy", "config_lzMsgLibVer-LzERC20RootTunnel"];
