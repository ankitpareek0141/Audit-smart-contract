// run: npx hardhat deploy --network binance_testnet --tags config_lzMsgLibVer-LzERC20ChildTunnel
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// root tunnel is available only in L2
	...
	// config LZ Endpoint: LzERC20ChildTunnel
	{
		...
		if(ua_send_version !== send_version) {
			...
			console.log("LzERC20ChildTunnel_Proxy.setSendVersion(%o): %o", send_version, receipt.transactionHash);
		}
		...
		if(receive_version !== ua_receive_version) {
			...
			console.log("LzERC20ChildTunnel_Proxy.setReceiveVersion(%o): %o", receive_version, receipt.transactionHash);
		}
	}
};
...
module.exports.tags = ["config_lzMsgLibVer-LzERC20ChildTunnel", "v2_9", "config", "L2", "l2"];
module.exports.dependencies = ["LzERC20ChildTunnel_Proxy", "setup-LzERC20ChildTunnel"];
