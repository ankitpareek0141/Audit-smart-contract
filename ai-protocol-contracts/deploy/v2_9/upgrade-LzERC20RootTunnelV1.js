// upgrade: npx hardhat deploy --network goerli --tags upgrade-LzERC20RootTunnel
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// LzERC20RootTunnel ERC1967Proxy
	{
		...
		if(implementation_address !== web3.utils.toChecksumAddress(v1_deployment.address)) {
			...
			console.log("LzERC20RootTunnel_Proxy.upgradeTo(%o): %o", v1_deployment.address, receipt.transactionHash);
		}
	}
};
...
module.exports.tags = ["upgrade-LzERC20RootTunnel", "v2_9", "upgrade", "L1", "l1"];
module.exports.dependencies = ["LzERC20RootTunnelV1", "LzERC20RootTunnel_Proxy"];
