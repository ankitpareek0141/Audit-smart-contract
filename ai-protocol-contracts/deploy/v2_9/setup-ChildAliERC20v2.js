// run: npx hardhat deploy --network binance_testnet --tags setup-ChildAliERC20v2
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// setup Child AliERC20
	{
		// get deployment details
		const deployment = await deployments.get("ChildAliERC20v2");
		...
		if(!features.eq(requested_features)) {
			...
			console.log("ChildAliERC20v2.updateFeatures(%o): %o", requested_features.toString(2), receipt.transactionHash);
		}
	}
};
...
module.exports.tags = ["setup-ChildAliERC20v2", "v2_9", "setup", "L2", "l2"];
module.exports.dependencies = ["ChildAliERC20v2"];
