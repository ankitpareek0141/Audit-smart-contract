// deploy: npx hardhat deploy --network binance_testnet --tags LzERC20ChildTunnel_Proxy
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	// LzERC20ChildTunnel ERC1967Proxy
	{
		...
		const proxy_init_data = v1_contract.methods.postConstruct(lz_endpoint, erc20_impl_deployment.address).encodeABI();

		// deploy ERC1967 proxy
		await deployments.deploy("LzERC20ChildTunnel_Proxy", {
...
module.exports.tags = ["LzERC20ChildTunnel_Proxy", "v2_9", "deploy", "L2", "l2"];
module.exports.dependencies = ["ChildAliERC20v2", "LzERC20ChildTunnelV1"];
