// deploy: npx hardhat deploy --network base_goerli --tags ERC20Shares
...
module.exports = async function({deployments, getChainId, getNamedAccounts, getUnnamedAccounts}) {
	...
	{
		// deploy if required
		await deployments.deploy("ERC20Shares", {
			...
			args: [
				...
				ZERO_ADDRESS, // ERC1363 _paymentToken
			],
		...
		const deployment = await deployments.get("ERC20Shares");
...
module.exports.tags = ["ERC20Shares", "v3_0", "deploy"];
